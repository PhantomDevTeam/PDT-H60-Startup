 ...
 *  2: _lightsOn       <BOOL>   - Turn lights on?              Default: false.
 *  3: _enableDoorguns <BOOL>   - Enable doorguns?             Defualt true.
 *
 *	Return Value:
 *	None
 *
...
params [["_heli", objNull], ["_debug", false], ["_lightsOn", false], ["_enableDoorguns", true]];
